...
function resolveGroupTemplate(groupDevices, compatibility) {
  ...
  if (switchSingleCount === 1 && switch3wayCount === 0 && lightCount === 3) {
    return {
      isSupported: true,
      templateId: "single_switch_2lights_same_time",
      switchType: undefined,
...
function effectiveGroupTemplate(allDevices, groupDevices, compatibility) {
    ...
    if (switchSingleCount === 1 && switch3wayCount === 0 && lightCount === 2) {
      ...
      if (supplyOutletCount > 1) {
        return {
          ...
          templateId: "single_switch_2lights_same_time",
          switchType: undefined,
          reasonCode: "single_2lights_multi_outlet_partial",
        };
      }
    }
    if (switchSingleCount === 1 && switch3wayCount === 0 && lightCount === 3) {
      ...
      if (supplyOutletCount > 1) {
        return {
          ...
          templateId: "single_switch_2lights_same_time",
          switchType: undefined,
          reasonCode: "single_3lights_multi_outlet_partial",
        };
      }
    }
    ...
    if (switchSingleCount === 4 && switch3wayCount === 0 && lightCount === 2) {
      ...
      if (supplyOutletCount > 1) {
        return {
          ...
          templateId: "single_switch_2lights_same_time",
          switchType: undefined,
          reasonCode: "single_4switches_2lights_multi_outlet_partial",
        };
      }
    }
    if (switchSingleCount === 4 && switch3wayCount === 0 && lightCount === 3) {
      ...
      if (supplyOutletCount > 1) {
        return {
          ...
          templateId: "single_switch_2lights_same_time",
          switchType: undefined,
          reasonCode: "single_4switches_3lights_multi_outlet_partial",
        };
      }
    }
    if (switchSingleCount === 4 && switch3wayCount === 0 && lightCount === 4) {
      const supplyOutletCount =
        groupDevices.filter((d) => d.kind === "outlet").length +
        allDevices.filter((d) => d.kind === "outlet" && typeof d.controlId !== "number").length;
      if (supplyOutletCount > 1) {
        return {
          ...
          templateId: "single_switch_2lights_same_time",
          switchType: undefined,
          reasonCode: "single_4switches_4lights_multi_outlet_partial",
        };
      }
    }
    return base;
  ...
  if (switchSingleCount === 1 && switch3wayCount === 0 && lightCount === 0) {
    ...
    if (supplyOutletCount > 1) {
      return {
        ...
        templateId: "single_switch_1light",
        switchType: undefined,
        reasonCode: "single_0light_multi_outlet_partial",
      };
    }
  }
  ...
  if (switchSingleCount === 1 && switch3wayCount === 0 && lightCount === 5) {
    ...
    if (!hasSupplyOutlet) {
      return {
        ...
        templateId: "single_switch_2lights_same_time",
        switchType: undefined,
        reasonCode: "single_5lights_diagram_two",
      };
    }
  }

  if (switchSingleCount === 1 && switch3wayCount === 0 && lightCount === 6) {
    const hasSupplyOutlet =
      outletInGroup ||
      allDevices.some((d) => d.kind === "outlet" && typeof d.controlId !== "number");
    if (!hasSupplyOutlet) {
      return {
        ...
        templateId: "single_switch_2lights_same_time",
        switchType: undefined,
        reasonCode: "single_6lights_diagram_two",
      };
    }
  }
  ...
  if (switchSingleCount === 0 && switch3wayCount === 2 && lightCount === 3) {
    return {
      isSupported: true,
      templateId: "three_way_1light",
      switchType: "threeway",
      reasonCode: "threeway_3lights_diagram_one",
    };
  }

  if (switchSingleCount === 0 && switch3wayCount === 2 && lightCount === 4) {
    return {
      isSupported: true,
      templateId: "three_way_1light",
      switchType: "threeway",
      reasonCode: "threeway_4lights_diagram_one",
    };
  }
  ...
  if (switchSingleCount === 2 && switch3wayCount === 0 && lightCount === 1) {
    ...
    if (supplyOutletCount > 1) {
      return {
        ...
        templateId: "single_switch_1light",
        switchType: undefined,
        reasonCode: "single_2switches_1light_multi_outlet_partial",
      };
    }
  }
  ...
  if (switchSingleCount === 3 && switch3wayCount === 0 && lightCount === 1) {
    ...
    if (supplyOutletCount > 1) {
      return {
        ...
        templateId: "single_switch_1light",
        switchType: undefined,
        reasonCode: "single_3switches_1light_multi_outlet_partial",
      };
    }
  }
  ...
  if (switchSingleCount === 4 && switch3wayCount === 0 && lightCount === 1) {
    const supplyOutletCount =
      groupDevices.filter((d) => d.kind === "outlet").length +
      allDevices.filter((d) => d.kind === "outlet" && typeof d.controlId !== "number").length;
    if (supplyOutletCount > 1) {
      return {
        ...
        templateId: "single_switch_1light",
        switchType: undefined,
        reasonCode: "single_4switches_1light_multi_outlet_partial",
      };
    }
  }
  ...
  if (switchSingleCount === 4 && switch3wayCount === 0 && lightCount === 1) {
    return {
      ...
      templateId: "single_switch_1light",
      switchType: undefined,
      reasonCode: "single_4switches_1light_diagram_one",
    };
  }
  ...
  if (switchSingleCount === 4 && switch3wayCount === 0 && lightCount === 2) {
    return {
      ...
      templateId: "single_switch_2lights_same_time",
      switchType: undefined,
      reasonCode: "single_4switches_2lights_diagram_two",
    };
  }
  ...
  if (switchSingleCount === 4 && switch3wayCount === 0 && lightCount === 4) {
    return {
      ...
      templateId: "single_switch_2lights_same_time",
      switchType: undefined,
      reasonCode: "single_4switches_4lights_diagram_two",
    };
  }

  if (switchSingleCount === 4 && switch3wayCount === 0 && lightCount === 5) {
    const hasSupplyOutlet =
      outletInGroup ||
      allDevices.some((d) => d.kind === "outlet" && typeof d.controlId !== "number");
    if (!hasSupplyOutlet) {
      return {
        ...
        templateId: "single_switch_2lights_same_time",
        switchType: undefined,
        reasonCode: "single_4switches_5lights_diagram_two",
      };
    }
  }

  if (switchSingleCount === 4 && switch3wayCount === 0 && lightCount === 6) {
    const hasSupplyOutlet =
      outletInGroup ||
      allDevices.some((d) => d.kind === "outlet" && typeof d.controlId !== "number");
    if (!hasSupplyOutlet) {
      return {
        ...
        templateId: "single_switch_2lights_same_time",
        switchType: undefined,
        reasonCode: "single_4switches_6lights_diagram_two",
      };
    }
  }
  ...
  if (switchSingleCount === 3 && switch3wayCount === 0 && lightCount === 2) {
    ...
    if (supplyOutletCount > 1) {
      return {
        ...
        templateId: "single_switch_2lights_same_time",
        switchType: undefined,
        reasonCode: "single_3switches_2lights_multi_outlet_partial",
      };
    }
  }
  ...
  if (switchSingleCount === 3 && switch3wayCount === 0 && lightCount === 2) {
    return {
      ...
      templateId: "single_switch_2lights_same_time",
      switchType: undefined,
      reasonCode: "single_3switches_2lights_diagram_one",
    };
  }

  if (switchSingleCount === 3 && switch3wayCount === 0 && lightCount === 3) {
    const supplyOutletCount =
      groupDevices.filter((d) => d.kind === "outlet").length +
      allDevices.filter((d) => d.kind === "outlet" && typeof d.controlId !== "number").length;
    if (supplyOutletCount > 1) {
      return {
        ...
        templateId: "single_switch_2lights_same_time",
        switchType: undefined,
        reasonCode: "single_3switches_3lights_multi_outlet_partial",
      };
    }
  }
  ...
  if (switchSingleCount === 3 && switch3wayCount === 0 && lightCount === 3) {
    return {
      ...
      templateId: "single_switch_2lights_same_time",
      switchType: undefined,
      reasonCode: "single_3switches_3lights_diagram_two",
    };
  }

  if (switchSingleCount === 3 && switch3wayCount === 0 && lightCount === 4) {
    const supplyOutletCount =
      groupDevices.filter((d) => d.kind === "outlet").length +
      allDevices.filter((d) => d.kind === "outlet" && typeof d.controlId !== "number").length;
    if (supplyOutletCount > 1) {
      return {
        ...
        templateId: "single_switch_2lights_same_time",
        switchType: undefined,
        reasonCode: "single_3switches_4lights_multi_outlet_partial",
      };
    }
  }
  ...
  if (switchSingleCount === 3 && switch3wayCount === 0 && lightCount === 4) {
    return {
      ...
      templateId: "single_switch_2lights_same_time",
      switchType: undefined,
      reasonCode: "single_3switches_4lights_diagram_two",
    };
  }

  if (switchSingleCount === 3 && switch3wayCount === 0 && lightCount === 5) {
    const hasSupplyOutlet =
      outletInGroup ||
      allDevices.some((d) => d.kind === "outlet" && typeof d.controlId !== "number");
    if (!hasSupplyOutlet) {
      return {
        ...
        templateId: "single_switch_2lights_same_time",
        switchType: undefined,
        reasonCode: "single_3switches_5lights_diagram_two",
      };
    }
  }
  ...
  if (switchSingleCount === 4 && switch3wayCount === 0 && lightCount === 0) {
    ...
    if (supplyOutletCount > 1) {
      return {
        ...
        templateId: "single_switch_1light",
        switchType: undefined,
        reasonCode: "single_4switches_0light_multi_outlet_partial",
      };
    }
  }
  ...
  if (switchSingleCount === 2 && switch3wayCount === 0 && lightCount === 2) {
    ...
    if (supplyOutletCount > 1) {
      return {
        ...
        templateId: "single_switch_2lights_same_time",
        switchType: undefined,
        reasonCode: "single_2switches_2lights_multi_outlet_partial",
      };
    }
  }
  ...
  if (switchSingleCount === 2 && switch3wayCount === 0 && lightCount === 2) {
    return {
      ...
      templateId: "single_switch_2lights_same_time",
      switchType: undefined,
      reasonCode: "single_2switches_2lights_diagram_one",
    };
  }

  if (switchSingleCount === 2 && switch3wayCount === 0 && lightCount === 3) {
    const supplyOutletCount =
      groupDevices.filter((d) => d.kind === "outlet").length +
      allDevices.filter((d) => d.kind === "outlet" && typeof d.controlId !== "number").length;
    if (supplyOutletCount > 1) {
      return {
        ...
        templateId: "single_switch_2lights_same_time",
        switchType: undefined,
        reasonCode: "single_2switches_3lights_multi_outlet_partial",
      };
    }
  }
  ...
  if (switchSingleCount === 2 && switch3wayCount === 0 && lightCount === 3) {
    return {
      ...
      templateId: "single_switch_2lights_same_time",
      switchType: undefined,
      reasonCode: "single_2switches_3lights_diagram_two",
    };
  }

  if (switchSingleCount === 2 && switch3wayCount === 0 && lightCount === 4) {
    const supplyOutletCount =
      groupDevices.filter((d) => d.kind === "outlet").length +
      allDevices.filter((d) => d.kind === "outlet" && typeof d.controlId !== "number").length;
    if (supplyOutletCount > 1) {
      return {
        ...
        templateId: "single_switch_2lights_same_time",
        switchType: undefined,
        reasonCode: "single_2switches_4lights_multi_outlet_partial",
      };
    }
  }
  ...
  if (switchSingleCount === 2 && switch3wayCount === 0 && lightCount === 4) {
    return {
      ...
      templateId: "single_switch_2lights_same_time",
      switchType: undefined,
      reasonCode: "single_2switches_4lights_diagram_two",
    };
  }
  ...
  if (switchSingleCount === 2 && switch3wayCount === 0 && lightCount === 6) {
    const hasSupplyOutlet =
      outletInGroup ||
      allDevices.some((d) => d.kind === "outlet" && typeof d.controlId !== "number");
    if (!hasSupplyOutlet) {
      return {
        ...
        templateId: "single_switch_2lights_same_time",
        switchType: undefined,
        reasonCode: "single_2switches_6lights_diagram_two",
      };
    }
  }
  ...
  if (switchSingleCount === 2 && switch3wayCount === 0 && lightCount === 0) {
    ...
    if (hasSupplyOutlet) {
      return {
        ...
        templateId: "single_switch_1light",
        switchType: undefined,
        reasonCode: "single_2switches_0light_outlet_bus",
      };
    }
  }
